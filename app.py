...
<style>
    ...
    html, body, [class*="css"] {
        ...
        scroll-behavior: smooth !important; /* Trượt mượt mà nguyên bản của trình duyệt */
    }
    ...
    /* MENU NAVBAR GIAO DIỆN NÚT TRẮNG ĐẸP MẮT & BẮT MẮT */
    .nav-container {
        display: flex;
        gap: 15px;
        padding: 0.8rem 2rem;
...
# ==============================================================================
# 4. TOP NAVBAR HEADER & THANH MENU TRƯỢT MƯỢT MÀ (HTML NATIVE)
# ==============================================================================
st.markdown('''
...
<div class="nav-container">
    <a href="#section-overview" class="nav-btn">Trang Chủ</a>
    <a href="#section-rules" class="nav-btn">Mô Hình AI</a>
    <a href="#section-graph" class="nav-btn">Đồ Thị Network</a>
    <a href="#section-geoip" class="nav-btn">Bản Đồ GeoIP</a>
    <a href="#section-analytics" class="nav-btn">Analytics & Báo Cáo</a>
</div>
''', unsafe_allow_html=True)
...
# ==============================================================================
# 7. CÁC PHẦN NỘI DUNG (CÓ ĐỦ ANCHOR ID ĐỂ TRƯỢT XUỐNG CHÍNH XÁC)
# ==============================================================================

# --- MỤC 1: TRANG CHỦ & NỔI BẬT ---
